...
//    	ar.add(new Mainmenu(R.string.lang_calc, st.CMD_INPUT_METHOD));
    	...
    	ar.add(new Mainmenu(R.string.set_key_skins, st.CMD_RUN_SKIN_SELECT));
    	...
    	ar.add(new Mainmenu(R.string.gesture_trans_copy, st.CMD_TRANSLATE_COPYING));
