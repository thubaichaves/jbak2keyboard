...
//        new Keybrd("en_from_MWcorp",   R.string.kbd_name_mwcorp),
        ...
        new Keybrd("en_qwerty_Round",   R.string.kbd_name_round_pb),
        ...
        new Keybrd("ru_qwerty_Round",   R.string.kbd_name_round_pb),
        ...
        new Keybrd("symbol_Round",   R.string.kbd_name_round_pb),
        new Keybrd("edittext_MWcorp",   R.string.lang_edittext2),
        new Keybrd("edittext_standard",R.string.lang_edittext),
        new Keybrd("edittext_Round",   R.string.kbd_name_round_pb),
        ...
        new Keybrd("num_Round",   R.string.kbd_name_round_pb),
