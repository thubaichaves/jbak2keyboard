...
// ключи для настроек цветов автодополнения
    ...
    /** @deprecated Ключ, нужно выпилить */    
...
/** Внутреняя команда - создание папки шаблонов */  
    ...
    public static final int CMD_RUN_SKIN_SELECT = -512;
    ...
    /** внутренняя команда - запуск переводчика*/    
    public static final int CMD_TRANSLATE_COPYING = -609;
