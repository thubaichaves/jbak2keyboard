...
// избранное
    	...
    	for (int i =0;i<st.runapp_favorite.size();i++){
            ...
            ftext.setSpan(new ForegroundColorSpan(Color.MAGENTA), 0, st.runapp_favorite.get(i).indexOf(st.STR_CR), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            ftext.setSpan(new  ForegroundColorSpan(Color.GREEN), st.runapp_favorite.get(i).indexOf(st.STR_CR)+1,st.runapp_favorite.get(i).length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
...
//	}
	...
	public void onClickRescan(View view) 
	{
	    ...
	    for (int i=0; i<pm1.size();i++) {
    		...
    		st.runapp_all[i] = name+st.STR_CR+label;
	    }
...
// записываем новые		
	...
	View.OnClickListener run_clkListener = new View.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
			  ...
			  run = run.substring(run.indexOf(st.STR_CR)+1);
	...
	View.OnClickListener m_clkListener = new View.OnClickListener()
    {
	  ...
	  public void createAll(String text, int id, int rejim) 
	  {
    	  ...
    	  stext.setSpan(new ForegroundColorSpan(Color.CYAN), 0, text.indexOf(st.STR_CR), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    	  stext.setSpan(new  ForegroundColorSpan(Color.GREEN), text.indexOf(st.STR_CR)+1,text.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
