...
//        m_MainView.setBackgroundDrawable(st.getBack());
        ...
        save_skin = (Button) m_MainView.findViewById(R.id.save_skin);
        if (save_skin!=null){
            save_skin.setOnClickListener(m_clkListener);
            save_skin.setVisibility(View.GONE);
        }
        ...
        else if(m_curAction==st.SET_SELECT_SKIN)
        {
        	...
        	if (m_kbd.m_curDesign.path!=null
        			...
        			&&save_skin!=null)
                save_skin.setVisibility(View.VISIBLE);

            String name = st.arDesign[m_curSkin].getName(this);
//            ((TextView)m_MainView.findViewById(R.id.keyboard_name)).setText(drawable.ic);
    ...
    void setBackColor()
    {
		...
		switch(st.set_kbdact_backcol)
		{
			...
			case 5:
				...
				break;
			case 6:
				m_MainView.setBackgroundDrawable(
					new GradBack(0xffFF8C00, 0xffaa0000)
				.setCorners(0, 0).setGap(0)
				.setDrawPressedBackground(false)
				.getStateDrawable());
				break;
			case 7:
				m_MainView.setBackgroundDrawable(
						new GradBack(0xff00ffee, 0xffaa0000)
					.setCorners(0, 0).setGap(0)
					.setDrawPressedBackground(false)
					.getStateDrawable());
					break;
			case 8:
				m_MainView.setBackgroundDrawable(
					new GradBack(0xff8B008B, 0xffaa0000)
				.setCorners(0, 0).setGap(0)
				.setDrawPressedBackground(false)
				.getStateDrawable());
				break;
